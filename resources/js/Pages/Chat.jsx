...
export default function ChatPage() {
    ...
    return (
        <div className="h-screen flex flex-col font-utama bg-gray-100">
    {/* Header: tinggi tetap */}
    ...
    {/* Area Chat Utama (yang fleksibel) */}
    <main className="flex-1 overflow-y-auto px-4 py-6 md:px-12">
        <div ref={chatAreaRef} className="max-w-3xl mx-auto space-y-8">
            {/* Chat content */}
    ...
    {/* Footer/Form input: tinggi tetap */}
    <footer className="h-24 px-4 py-4 md:px-12 bg-gray-100 border-t">
        <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto h-full flex items-center">
