...
//             ),
//             title: "Kelola Sampah dengan Mudah",
//             description: "Setor sampah dan dapatkan poin yang bisa ditukar dengan berbagai keuntungan.",
//         },
//         {
//             icon: (
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 16 16">
...
//             description: "Bersama kita mengurangi dampak lingkungan dan menciptakan ekonomi sirkular.",
//         },
//         {
//             icon: (
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 16 16">
...
//             ),
//             title: "Transparan & Digital",
//             description: "Akses data sampah dan poin kapan saja melalui aplikasi Pusaka.",
//         },
//     ];
...
//                     <header className="flex items-center justify-between flex-wrap p-6 bg-neutralsilver">
//                         {/* Logo */}
...
//                             <div className="flex flex-wrap justify-center items-center gap-12 w-full rounded-[12.1px]">
//                                 {/* Total Users */}
//                                 <div className="w-[147.72px] space-y-4 relative flex flex-col items-center justify-center text-center">
//                                     <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 text-main" viewBox="0 0 16 16">
//                                         <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
//                                         <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1" />
//                                     </svg>
//                                     <div className='flex flex-col space-y-1'>
//                                         <div className="font-extrabold text-main text-[36.3px] leading-[39.3px]">{totalUsers}</div>
//                                         <div className="font-semibold text-[#6d6d6d] text-lg leading-[18.2px]">Pengguna</div>
//                                     </div>
...
//                                     </svg>
//                                     <div className='flex flex-col space-y-1'>
//                                         <div className="font-extrabold text-main text-[36.3px] leading-[39.3px]">{totalBeratSampah}</div>
//                                         <div className="font-semibold text-[#6d6d6d] text-lg leading-[18.2px]">Total Sampah (kg)</div>
//                                     </div>
...
//                                     </svg>
//                                     <div className='flex flex-col space-y-1'>
//                                         <div className="font-extrabold text-main text-[36.3px] leading-[39.3px]">{totalSetoran}</div>
//                                         <div className="font-semibold text-[#6d6d6d] text-lg leading-[18.2px]">Setoran</div>
//                                     </div>
...
//                                     </svg>
//                                     <div className='flex flex-col space-y-1'>
//                                         <div className="font-extrabold text-main text-[36.3px] leading-[39.3px]">{totalProdukOlahan}</div>
//                                         <div className="font-semibold text-[#6d6d6d] text-lg leading-[18.2px]">Produk Olahan</div>
//                                     </div>
...
//                             <div className="w-full font-semibold text-neutralblack text-xl text-center leading-[25.4px]">
//                                 Dukung lingkungan yang lebih bersih & hijau.
//                             </div>

//                             <Link
//                                 href={route('register')}
//                                 className="w-full max-w-[200px] px-6 py-2.5 bg-main hover:bg-main_dark rounded-xl text-center font-semibold text-white text-sm"
//                             >
//                                 GABUNG SEKARANG
//                             </Link>
//                         </div>
      ...
      <div className="bg-white flex justify-center w-full">
        <div className="w-full">
          ...
          <section className="w-full bg-[#F5F7FA]">
            <div className="w-full max-w-6xl mx-auto px-6 md:px-10 py-12">
          ...
          {/* CTA Section */}
          <section className="w-full bg-neutralwhite">
            <div className="w-full max-w-6xl mx-auto px-6 md:px-10 py-12 flex flex-col items-center gap-6">
              <div className="font-semibold text-neutralblack text-xl text-center leading-snug">
                Dukung lingkungan yang lebih bersih & hijau.
              </div>
              <Link
                href={route('register')}
                className="px-6 py-3 bg-main hover:bg-main_dark rounded-xl text-center font-semibold text-white text-sm"
              >
                GABUNG SEKARANG
              </Link>
            </div>
