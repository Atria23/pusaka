                ...
                <div className="fixed top-0 left-1/2 -translate-x-1/2 max-w-[500px] w-full z-20 bg-main">
                    <div className="w-full flex flex-row justify-between items-center px-4 py-2 bg-main">
                        ...
                        <div className="flex flex-row items-center space-x-4">
                            <div className="font-bold text-white text-lg">Profil</div>
                        </div>
                ...
                <div className="w-full w-max-[500px] flex flex-col space-y-5 mt-10 p-4 bg-main-white">
                    ...
                    <div className="w-full flex flex-col space-y-4 items-start justify-start">
                        ...
                        <div className="w-full flex flex-col space-y-2 p-4 rounded-lg bg-white shadow-md">
                            ...
                            <a href={route('produk-olahan.user.index')} className="w-full flex flex-row justify-between items-center p-4 rounded-lg">
                                <div className="flex flex-row space-x-4 items-center justify-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-main" viewBox="0 0 16 16">
                            ...
                            <a href={route('voucher')} className="w-full flex flex-row justify-between items-center p-4 rounded-lg">
                                <div className="flex flex-row space-x-4 items-center justify-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-main" viewBox="0 0 16 16">
                    ...
                    <div className="w-full flex flex-col space-y-4 items-start justify-start">
                        ...
                        <div className="w-full flex flex-col space-y-2 p-4 rounded-lg bg-white shadow-md">
                            ...
                            <a href="https://wa.me/6287742097918" className="w-full flex flex-row justify-between items-center p-4 rounded-lg">
                                <div className="flex flex-row space-x-4 items-center justify-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-main" viewBox="0 0 16 16">
                    ...
                    <button
                        ...
                        className="w-full py-2 px-4 rounded-xl text-white bg-red-500 hover:bg-red-700"
                    >
                        Logout
                    </button>
                </div>
