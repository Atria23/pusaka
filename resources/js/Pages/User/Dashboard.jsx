      ...
      <div className="mx-auto w-full max-h-[892px] min-h-screen">
        ...
        <div className="w-full flex flex-col space-y-7 pt-7 pb-6">
          ...
          <a
            ...
            className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-2xl shadow-[0_8px_30px_rgba(0,0,0,0.3)] transform hover:scale-110 transition-all duration-200"
            title="Buka Asisten AI"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5 text-main" viewBox="0 0 16 16" stroke="currentColor" strokeWidth="1">
            ...
            <div className="w-full grid grid-cols-3 gap-x-6 gap-y-4">
              {[
                ...
                },
                {
                  name: 'Plastik HDPE',
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-8 h-8 text-white" fill="currentColor">
