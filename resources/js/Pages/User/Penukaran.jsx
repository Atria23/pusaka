                        ...
                        return (
                            <div key={p.id} className="rounded-lg overflow-hidden shadow-md bg-white">
                                <div className="relative">
                                    ...
                                    <div className={`absolute top-3 right-3 text-xs font-semibold py-1 px-3 rounded ${p.status === 'sudah diredeem' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}`}>
                                        {p.status}
                                    </div>
                                </div>
            ...
            {selectedPenukaran && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="flex flex-col items-center justify-center bg-white rounded-lg p-6 w-[300px] text-center relative">
                        <h3 className="font-bold text-lg mb-4">QR Penukaran</h3>
                        <QRCodeCanvas value={`${selectedPenukaran.id}`} size={200} />
                        <p className="mt-3 text-sm text-gray-600">ID Penukaran: {selectedPenukaran.id}</p>
                        ...
                        <div className="mt-4 px-3 py-2 bg-yellow-100 text-yellow-800 rounded-md shadow-md">
                            ...
                            <p className="text-sm text-justify">
                                Tunjukkan QR atau ID ini ke petugas <b>Bank Sampah Pusaka</b> saat penukaran.
                            </p>
                        </div>
